  ...
  return (
    <>
      ...
      <Container fluid bg={"#f2f2f2"} p={0}>
        ...
        <Grid px={100} gutter={50}>
          <Grid.Col span={9} mt={60}>
            <Stack gap={20}>
              ...
              <Box>
                ...
                >
                  <Stack gap={10}>
                    ...
                    <Flex gap={80} align={"center"} ml={20}>
                      <Text fw={700} fz={14} tt="uppercase" c={"#4c4b4c"}>
                        Makkah Hotel
                      </Text>
                      <Text size="sm" color="dimmed">
                        Diafat Al Raja / Ramada Makka or Similar at 400 meters'
                      </Text>
                    </Flex>
                    <Divider my="sm" size={"xs"} />
                    <Flex gap={84} align={"center"} ml={20}>
                      <Text fw={700} fz={14} tt="uppercase" c={"#4c4b4c"}>
                        Madina Hotel
                      </Text>
                      <Text size="sm" color="dimmed">
                        Ramada Al Haram / Hayah Plaza or Similar at 100 meters'
                      </Text>
                    </Flex>
                    <Divider my="sm" size={"xs"} />
              ...
              <Grid>
                <Grid.Col span={4}>
                  <Card radius={0} w={270} p={0}>
                    <BackgroundImage h={"280px"} src={image31} pos={"relative"}>
                      <Box
                        bg="#ffb300"
                        h={35}
                        w="40%"
                ...
                <Grid.Col span={4}>
                  <Card radius={0} w={270} p={0}>
                    <BackgroundImage h={"285px"} src={image30} pos={"relative"}>
                      <Flex justify={"end"}>
                        <Badge
                          color="#26bdf7"
                          pos={"absolute"}
          ...
          <Grid.Col span={3} p={0} top={0}>
            <Box>
              <Text fz={20} fw={500} ta="center" mt={30}>
                Book the tour
              </Text>
              <Flex justify={"center"}>
                <Divider w={"45%"} mb={20} size={"sm"} />
              </Flex>
            </Box>
            <Stack gap={20}>
              <Card
        ...
        >
          <Flex gap={60}>
            <Stack gap={4} style={{ maxWidth: 250 }}>
              <Text fw={500} size="lg">
                CONTACT
              </Text>
